...
(function() {
  ...
  Classifier = function(n, power, smoothing) {
    n = n|0;
    power = +power;
  ...
  Classifier.prototype = {
    ...
    classify: function(features) {
      ...
      for(label = this.labels.length; label--; ) {
